...
public class AncientMonkey : BloonsTD6Mod
{
    ...
    public class MenuUi : MonoBehaviour
    {
        ...
        public void Upgrade1Panel(Tower tower)
        {
            ...
            ModHelperText text9 = panel.AddText(new Info("text9", 0, -300, 2500, 180), "-Base Monkey is Stronger", 75);
            ModHelperText text20 = panel.AddText(new Info("text10", 0, -400, 2500, 180), "-Reset Everything", 75);
